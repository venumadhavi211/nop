    ...
    public partial class PluginController : BaseAdminController
    {
        ...
        public virtual IActionResult Install(IFormCollection form)
        {
            ...
            try
            {
                ...
                if (!_nopConfig.UseOldPluginsManager)
                {
                    PluginManager.AddPluginToInstall(pluginDescriptor);
                }
                else
                {
                    //install plugin
        ...
        public virtual IActionResult Uninstall(IFormCollection form)
        {
            ...
            try
            {
                ...
                if (!_nopConfig.UseOldPluginsManager)
                {
                    PluginManager.AddPluginToUnInstall(pluginDescriptor);
                }
                else
                {
                    //uninstall plugin
        ...
        public virtual IActionResult Delete(IFormCollection form)
        {
            ...
            try
            {
                ...
                if (!_nopConfig.UseOldPluginsManager)
                {
                    PluginManager.AddPluginToDelete(pluginDescriptor);
                }
                else
                {
        ...
        public virtual IActionResult ReloadList()
        {
            ...
            PluginManager.UninstallAndDeletePluginsIfNeed();
